...
```{r model_fit, fig.env = "figure", fig.pos = "H", fig.align='center',  fig.height=4, set.cap.width=T, num.cols.cap=1, fig.cap = "Plot of the fit between model predictions and empirical data."}
