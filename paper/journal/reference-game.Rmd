...
3. *Indifferent* - under this model, the parent produces a linguistic label in each communicative event regardless of the child's vocabulary state. (Note: this model is a special case of the communicator that minimizes communicative cost without seeking to maximize communicative success.)

the child's linguistic development. Each communicative event in this model consists of an ostensive labelling event (Note: this model is equivalent to a *Communicator* who ignores communicative cost).
