...
We take as our inspiration a long history of work in philosophy of language describing the functional purpose of lanuage [e.g. @wittgensetein1953; @austin1975]. In this framework, speakers choose the words they produce in order to maximize their probability of successfully communicating some intended meaning while minimizing the cost of speech production [@grice1975; @clark1996]. Recently, @frank2012 developed the Rational Speech Act framework--a formal instantation of these ideas. In their work, speakers choose among a set of potential alternative utterances by maximizing a utility function that combines the probability that a listener will correctly infer their intended meaning along with a cost of producing each word. This framework has found successful application in a variety of linguistic applications such as scalar implicature, conventional pact formation, and production and interpretation of hyperbole [@kao2014].

of language grappling with the functional aspects of language. From a functional performulating speech as a kind of action 

We take as inspiration the idea that communication is a kind of action--e.g. talking is a speech act [@austin1975]. Consequently, we can understand the choice of *which communicative act* a speaker should take as a question of which act would maximize their utility: achieving successful communication while minimizing their cost [@frank2012].
