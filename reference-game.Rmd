...
filenames <- list.files("12.6_instructions_pilot/production-results/", pattern="*.json", full.names = TRUE)
...
```{r}
all_data <- game %>%
  # filter(subID %in% ruleCorrect$subID) %>%
