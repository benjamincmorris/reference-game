...
//transition from instruction slide to the exposure phase
 ...
 //      box.removeClass(hm)
  ...
  prestudyTimer: function(slideNumber, ifStart) {
    ...
    setTimeout(function() {
      document.getElementById("timerText").innerHTML = "<br> Whatever message you send, you will be charged points based on how long it takes you to send your message."
      $("#timerText").fadeIn(500)
    }, 500)
    setTimeout(function() {
      initializeTimer("countdownExample", 30, true)
      $("#ifRight").fadeIn(500)
      document.getElementById("ifRight").innerHTML = "You can win a maximum of 100 points. This timer above shows how much you have been charged so far, and how much you could still win (always >= 10 points)."
    }, 3500)
    setTimeout(function() {
      $("#ifRight").append("<br> <strong>The timer starts when you press a key.</strong>")
    }, 7500)
        ...
        if(event.keyCode == 13) {
          ...
          if (levDist(document.getElementById("ifTyping").value, "shoe") > 2) {
            ...
            if(ifStart) {
              ...
              // since you took X seconds, you were charged Y points and end up with Z points
              document.getElementById('ifClick').innerHTML = "After being charged " + (100-pointsEx) +" points, <br> you would end up with <strong>" + (pointsEx) + " points</strong>."
              $("#ifClick").fadeIn(500)
            }
          ...
          $(window).on('keyup', function(event){
            if(event.keyCode == 13) {
              ...
              if (levDist(document.getElementById("ifTyping").value, "chair") > 2) {
                ...
                $("#ifTypePoints").hide()
                $("#sendMessageDemo").hide()
                document.getElementById("ifClick").innerHTML="But if your partner gets it wrong based on your message... <br> You will be charged for your message and end up with <strong> 0 points</strong>."
                            ...
                            if (demoSelection != 'shoe') {
                              ...
                              setTimeout(function() {
                                if (clockOnIfTrue==true) {
                                  ...
                                  document.getElementById("ifClick").innerHTML="After being charged " + (100-pointsEx) +" points, <br> you would end up with <strong>"+(pointsEx)+" points </strong> <br> when your partner gets it right."
                                } else {
                              ...
                              $("#sendMessageDemo").hide()
                                ...
                                setTimeout(function() {
                                        if (clockOnIfTrue) {
                                          ...
                                          document.getElementById("ifClick").innerHTML="After being charged "+(100-pointsEx)+" points for time, you end up with <strong>" + (pointsEx) + " points</strong> and your partner learned this is a 'shoe.'"
