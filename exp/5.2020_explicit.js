...
var condOptions = ["100_30", "80_50"]
  // 3 listener training levels (0, same, double)
var listenerOptions = ["0","1", "perfect"]
...
if(cond == "80_50") {
  ...
  var doingBothPoints = 30;
  var pointsLabelWrong = -20;
  var pointsClickWrong = -50;
  var pointsBothWrong = -70;
}
...
var experiment = {
  ...
  prestudy: function(slideNumber) {
    ...
    document.getElementById("howToPlay").onclick = function() {
        ...
        setTimeout(function() {
          document.getElementById('timerText').innerHTML ="<br><br><br>You can send a message by: <br>typing,<br>pointing"
  ...
  prestudyTypeRight: function(slideNumber) {
    slide_number=slideNumber;  
       document.getElementById("ifType").innerHTML="You can type a label here...";
        ...
        $("#topText").fadeOut(500)
        document.getElementById('timerText').innerHTML ="<br><br><br>You can send a message by: <br><strong>typing,</strong><br>pointing"
        ...
        document.getElementById("gameReady").onclick = function() {
          ...
          //clicking example
          document.getElementById("gameReady").onclick = function() {
            document.getElementById('timerText').innerHTML ="<br><br><br>You can send a message by: <br><strike>typing,</strike><br><strong>pointing</strong>"
  ...
  gameQuestions: function(slideNumber) {
        ...
        $('.clickQ').on("change", function() {
          clickAnswered = true
          $(".clickQ").each(function() { 
            if (this.checked == true) {
              gotOne = true
              if (labelAnswered != false) {
        ...
        $('.labelQ').on("change", function() {
        labelAnswered = true
          $(".labelQ").each(function() { 
            if (this.checked == true) {
              gotOne = true
              if (clickAnswered != false) {
                document.getElementById("beginGame").disabled=false
              }
              labelQ = this.value
              }
				...
				document.getElementById("beginGame").onclick = function() {
					if (clickQ != trueClickPoints) {
						ruleCheckProblems += 1;
					}
					if (labelQ != trueLabelPoints) {
						ruleCheckProblems += 1;
					}
              ...
              condition: cond,
						...
						pointsClick : clickQ,
						pointsLabel : labelQ,
						clickCorrect : clickQ == trueClickPoints,
						labelCorrect : labelQ == trueLabelPoints,
					...
					if (ruleCheckProblems>0) {	
						document.getElementById("wrongCorrection").innerHTML= "It looks like you missed <em>" + ruleCheckProblems + "</em> of our questions."
						$('#wrongCorrection').show();
						$('#beginGame').hide();
						setTimeout(function() {
              $("#wrongCorrection").html("Remember, you get "+trueClickPoints+" points if you click and your partner gets it right.")
              setTimeout(function() { 
                $("#wrongCorrection").append("<br><br> You get "+trueLabelPoints+" points if you type and your partner gets it right.")
              }, 2000)
              setTimeout(function() {
                $("#wrongCorrection").append("<br><br> You will be charged for your message if your partner gets it wrong.")
              }, 4000)
              setTimeout(function() {
                $("#wrongCorrection").append("<br><br> Now, let's Find that Partner!")
              }, 7000)
              setTimeout(function() {experiment.partnering(0, 0, slideNumber+2)
              }, 8500);
            }, 3500);
					} else {
						$('#beginGame').hide();
    ...
    $("#squareExamples").hide()
      ...
      $("#userName").hide()
			document.getElementById("partneringText").innerHTML = " "
      ...
      // we found a partner!
        ...
        $("#exposureText").append("<br><br> You're Ready to Play! <br>")
				document.getElementById("gameStartFinal").innerHTML= "Ready!"
				document.getElementById("gameStartFinal").onclick = function() {
                $("#gameStartFinal").hide()
                ...
                document.getElementById("exposureText").innerHTML = "<br> NOTE: You will be asked to send messages to your partner about each object <strong>3 times.</strong> <br><br>"
                setTimeout(function() {
