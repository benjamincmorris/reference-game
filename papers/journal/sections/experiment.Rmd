...
```{r teach, cache=TRUE, fig.height = 3, fig.width = 4.5, set.cap.width=T, num.cols.cap=1, fig.cap = "Rates of teaching across the 6 conditions, plotted by how many times an object had been the target object."}
...
plot_prop_methods_teaching %>%
  ...
  geom_text(data = teach_label_data, size = 3.5)
```
