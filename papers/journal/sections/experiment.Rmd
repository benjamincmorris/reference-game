...
Across conditions, we manipulated the relative costs of these two communicative methods (point and speak), as we did not have a direct way of assessing these costs in our naturalistic data, and they likely vary across communicative contexts. In all cases, we assumed that pointing was more costly than speech.  Though this need not be the case for all gestures and contexts, our framework compares simple lexical labeling and unambiguous deictic gestures, which likely are slower and more effortful to produce [e.g., see @yurovsky2018children]. We set the relative costs by explicitly implementing strategy utility, assigning point values to each communicative method.
