...
This parental alignment is straightforwardly predicted from a dyadic framework [@yurovsky2018] that privleges commmunicative goals, yet wholly missing from learner-centric accounts of language learning. While some early accounts of language learning suggested a powerful role of tuned input [e.g., @levelt1975], influential investigations of possible alignment in language input susggested that fine-tuning was unlikely, perhaps because these investigations largely focused on syntax [@newport1977]. As a result, the role and importance of alignment has been understudied in research on language acquisition, but this work and other recent demonstrations show that parental alignment may aid language learning for a variety of communicatively-relevant language problems [e.g., @yurovsky2016, @leung2021].
