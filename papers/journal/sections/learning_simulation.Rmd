...
The communication model's behavior depends on parameters of both the child learner and the parent communicator.

Surprisingly, both the speaker's rationality ($\alpha$) and future discounting ($\gamma$) had relatively small effects on the rate of learning. 


As the speaker's rationality  of parameters: The speaker's rationality $\alpha$, and the the speaker's discounting of the future , the costs of both speaking ($S$) and pointing ($P$). Perhaps surprisingly, there both rationality and discounting had 

### Talking.

Finally, the cross-situational learner's behavior depends on a number of learner paramteres. 
