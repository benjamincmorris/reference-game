...
```{r comm-pomdp, fig.width = 4.5, fig.cap = "A schematic of the plan-act-update cycle of communication as a partially observable Markov decision process (POMDP). The red figure correponds to caregivers in the world, or participants in the experiment. The blue figure corresponds to children or experimental partners."}
